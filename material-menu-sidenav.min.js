...
ngMaterialMenu.directive("mdMenuSidenav", function (a) {
    return {
        transclude: true, link: function () {
        }, template: "<div flex layout='row'><div flex ng-transclude=''></div></div>"
    }
});
ngMaterialMenu.directive("mdToogleMenu", function (a) {
    return {
        link: function (c, b) {
            var d = a.generateID();
            b.on("click", function () {
...
ngMaterialMenu.directive("mdMenuSidenavContent", function (a) {
    return {
...
ngMaterialMenu.directive("mdDivider", function () {
    return {template: "<div style='height:1px;'></div>"}
});